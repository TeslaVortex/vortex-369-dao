...
contract PellionShield {
    ...
    uint256 constant deltax1 = 21029636708801604242260342910433999752215400240479634234475224650113225336836;
    uint256 constant deltax2 = 21870043105678723104185363514178761771200979259875449821325206039804094496908;
    uint256 constant deltay1 = 12503934178523478761712708384087685307827745710997124664636023037982705713066;
    uint256 constant deltay2 = 8091274430412002507689981658185321784296904967890009663586085894322749373664;
    ...
    function verifySecret(uint[2] memory _pA, uint[2][2] memory _pB, uint[2] memory _pC, uint[1] memory _pubSignals) public view returns (bool) {
        assembly {
